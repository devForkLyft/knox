...
const CarosuelTab2 = () => {
  return (
    <div className="flex flex-col justify-between w-full bg-[#222221] rounded-2xl min-h-[600px] p-4 md:p-10">
      {/* Title Section */}
      ...
      <div className="flex flex-col md:flex-row w-full">
        ...
        <div className="w-full md:w-1/2 md:pr-4 mb-6 md:mb-0">
          <h2 className="text-sm font-bold uppercase tracking-wide text-white">What to Bring</h2>
          <p className="mt-2 text-base md:text-lg font-sans leading-relaxed text-white">
        ...
        <div className="w-full md:w-1/2 md:pl-4">
          <h2 className="text-sm font-bold uppercase tracking-wide text-white">First Timer Briefing</h2>
          <p className="mt-2 text-base md:text-lg font-sans leading-relaxed text-white">
