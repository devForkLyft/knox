...
function ProgramNavBar({ activeTab, setActiveTab }: ProgramNavBarProps) {
  return (
    <div className='pt-48 md:scroll-pt-36 px-5'>
      <h1 className='text-2xl md:text-3xl lg:text-5xl font-normal mono mb-6 md:mb-5'>
        Tailored Programs. Tangible Results.
      </h1>
      <div className='flex flex-wrap items-center gap-2 md:gap-4 font-sans'> 
        <button 
          onClick={() => setActiveTab('all')}
          className={`text-[14px] md:text-[16px] mono px-3 md:px-4 py-1.5 md:py-2 font-normal leading-[20px] rounded-full transition-colors whitespace-nowrap
